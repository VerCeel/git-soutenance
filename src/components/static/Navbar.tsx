...
const NavBar = () => {
  return (
    <div className="fixed top-0 right-2 left-2 w-auto shadow z-50 flex items-center justify-between px-4 py-3 my-2 rounded-lg border border-white/25 bg-white/50 backdrop-blur-3xl">
